...
namespace Yay.Enumerations.MVC.UiHints
{
	...
	public class RadioButtonListAttribute : UIHintAttribute
	{
		public RadioButtonsOrientation RadioButtonsOrientation { get; set; }
		...
		public RadioButtonListAttribute() : base("EnumerationRadioButtonList")
		{
			CustomProviderType = typeof (ConventionalEnumerationsOptionsProvider);
			RadioButtonsOrientation = RadioButtonsOrientation.Vertical;
		}
		...
		public IEnumerable<SelectListItem> GetOptions(EnumerationBase attemptedValue, Type enumerationType)
		{
			...
			return EnumerationSelectListItemGenerator.GenerateSelectListItems(attemptedValue, enums, false);
		}
	}
